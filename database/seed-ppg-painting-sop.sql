...
SELECT id, 'Safe colour matching', 'Correspondance sûre des couleurs', 'Igualación segura del color', true, 1 FROM public.quiz_questions WHERE question_text_en = 'What is the first step in the PPG 9-step painting procedure?'
UNION ALL
SELECT id, 'Mixing the base coat', 'Mélange de la couche de base', 'Mezcla de la capa base', false, 2 FROM public.quiz_questions WHERE question_text_en = 'What is the first step in the PPG 9-step painting procedure?'
UNION ALL
SELECT id, 'Cleaning the primer', 'Nettoyage de l''apprêt', 'Limpieza del imprimador', false, 3 FROM public.quiz_questions WHERE question_text_en = 'What is the first step in the PPG 9-step painting procedure?'
UNION ALL
SELECT id, 'Checking the surface temperature', 'Vérification de la température de surface', 'Verificación de la temperatura superficial', false, 4 FROM public.quiz_questions WHERE question_text_en = 'What is the first step in the PPG 9-step painting procedure?';
...
INSERT INTO public.quiz_answers (question_id, answer_text_en, answer_text_fr, answer_text_es, is_correct, answer_order)
SELECT id, 'The base coat must flash off completely and appear uniformly matte', 'La couche de base doit sécher complètement et apparaître uniformément mate', 'La capa base debe secarse por completo y verse uniformemente mate', true, 1 FROM public.quiz_questions WHERE question_text_en = 'What must happen before you apply clear coat over the base coat?'
UNION ALL
SELECT id, 'The base coat should still be slightly wet for adhesion', 'La couche de base doit être encore légèrement humide', 'La capa base debe estar todavía ligeramente húmeda', false, 2 FROM public.quiz_questions WHERE question_text_en = 'What must happen before you apply clear coat over the base coat?'
UNION ALL
SELECT id, 'Apply a tack coat of primer first', 'Appliquer d''abord une couche d''apprêt', 'Aplicar primero una capa de imprimador', false, 3 FROM public.quiz_questions WHERE question_text_en = 'What must happen before you apply clear coat over the base coat?'
UNION ALL
SELECT id, 'Sand the base coat with P80 grit', 'Poncer la couche de base avec du P80', 'Lijar la capa base con grano P80', false, 4 FROM public.quiz_questions WHERE question_text_en = 'What must happen before you apply clear coat over the base coat?';
...
INSERT INTO public.quiz_answers (question_id, answer_text_en, answer_text_fr, answer_text_es, is_correct, answer_order)
SELECT id, 'P1500-P2000', 'P1500-P2000', 'P1500-P2000', true, 1 FROM public.quiz_questions WHERE question_text_en = 'What grit range is used for wet sanding when cutting the clear coat?'
UNION ALL
SELECT id, 'P80-P120', 'P80-P120', 'P80-P120', false, 2 FROM public.quiz_questions WHERE question_text_en = 'What grit range is used for wet sanding when cutting the clear coat?'
UNION ALL
SELECT id, 'P320-P400', 'P320-P400', 'P320-P400', false, 3 FROM public.quiz_questions WHERE question_text_en = 'What grit range is used for wet sanding when cutting the clear coat?'
UNION ALL
SELECT id, 'P600-P800', 'P600-P800', 'P600-P800', false, 4 FROM public.quiz_questions WHERE question_text_en = 'What grit range is used for wet sanding when cutting the clear coat?';
...
INSERT INTO public.quiz_answers (question_id, answer_text_en, answer_text_fr, answer_text_es, is_correct, answer_order)
SELECT id, 'Infrared thermometer', 'Thermomètre infrarouge', 'Termómetro infrarrojo', true, 1 FROM public.quiz_questions WHERE question_text_en = 'What tool should be used to check surface temperature during the painting process?'
UNION ALL
SELECT id, 'Touch test by hand', 'Test tactile à la main', 'Prueba táctil a mano', false, 2 FROM public.quiz_questions WHERE question_text_en = 'What tool should be used to check surface temperature during the painting process?'
UNION ALL
SELECT id, 'Moisture meter', 'Hygromètre', 'Medidor de humedad', false, 3 FROM public.quiz_questions WHERE question_text_en = 'What tool should be used to check surface temperature during the painting process?'
UNION ALL
SELECT id, 'Paint thickness gauge', 'Jauge d''épaisseur de peinture', 'Medidor de espesor de pintura', false, 4 FROM public.quiz_questions WHERE question_text_en = 'What tool should be used to check surface temperature during the painting process?';
...
INSERT INTO public.quiz_answers (question_id, answer_text_en, answer_text_fr, answer_text_es, is_correct, answer_order)
SELECT id, 'Flash off', 'Séchage', 'Secado', true, 1 FROM public.quiz_questions WHERE question_text_en = 'In the PPG painting SOP, what step comes immediately after application of the base coat?'
UNION ALL
SELECT id, 'Application of clear coat', 'Application du vernis', 'Aplicación del barniz', false, 2 FROM public.quiz_questions WHERE question_text_en = 'In the PPG painting SOP, what step comes immediately after application of the base coat?'
UNION ALL
SELECT id, 'Cutting the clear coat', 'Coupe du vernis', 'Corte del barniz', false, 3 FROM public.quiz_questions WHERE question_text_en = 'In the PPG painting SOP, what step comes immediately after application of the base coat?'
UNION ALL
SELECT id, 'Laminating', 'Laminage', 'Laminado', false, 4 FROM public.quiz_questions WHERE question_text_en = 'In the PPG painting SOP, what step comes immediately after application of the base coat?';
...
INSERT INTO public.quiz_answers (question_id, answer_text_en, answer_text_fr, answer_text_es, is_correct, answer_order)
SELECT id, 'It affects flash times, film build, and final appearance', 'Elle affecte les temps de séchage, l''épaisseur du film et l''apparence finale', 'Afecta los tiempos de secado, el espesor de la película y la apariencia final', true, 1 FROM public.quiz_questions WHERE question_text_en = 'Why is checking surface temperature important in the painting process?'
UNION ALL
SELECT id, 'It determines the colour shade to use', 'Elle détermine la teinte à utiliser', 'Determina el tono de color a usar', false, 2 FROM public.quiz_questions WHERE question_text_en = 'Why is checking surface temperature important in the painting process?'
UNION ALL
SELECT id, 'It is only required for insurance documentation', 'C''est uniquement requis pour la documentation d''assurance', 'Solo se requiere para documentación de seguros', false, 3 FROM public.quiz_questions WHERE question_text_en = 'Why is checking surface temperature important in the painting process?'
UNION ALL
SELECT id, 'It has no real effect on the paint job', 'Cela n''a aucun effet réel sur la peinture', 'No tiene efecto real en el trabajo de pintura', false, 4 FROM public.quiz_questions WHERE question_text_en = 'Why is checking surface temperature important in the painting process?';
...
INSERT INTO public.quiz_answers (question_id, answer_text_en, answer_text_fr, answer_text_es, is_correct, answer_order)
SELECT id, 'Laminating', 'Laminage', 'Laminado', true, 1 FROM public.quiz_questions WHERE question_text_en = 'What is the 9th and final step in the PPG painting SOP?'
UNION ALL
SELECT id, 'Cutting the clear coat', 'Coupe du vernis', 'Corte del barniz', false, 2 FROM public.quiz_questions WHERE question_text_en = 'What is the 9th and final step in the PPG painting SOP?'
UNION ALL
SELECT id, 'Checking the surface temperature', 'Vérification de la température de surface', 'Verificación de la temperatura superficial', false, 3 FROM public.quiz_questions WHERE question_text_en = 'What is the 9th and final step in the PPG painting SOP?'
UNION ALL
SELECT id, 'Application of clear coat', 'Application du vernis', 'Aplicación del barniz', false, 4 FROM public.quiz_questions WHERE question_text_en = 'What is the 9th and final step in the PPG painting SOP?';
